...
全文搜索中文冒号、英文冒号、破折号和连接号式破折号。文章正文全部清零。网址、代码和机器字段可以保留。

搜索“不是……而是……”、“并非……而是……”、“不在于……而在于……”、“与其说……不如说……”、“不只……还……”、“不只……也……”、“表面……实际……”、“看似……实则……”及其变形。拆回事实陈述。

搜索“不丢”“说白了”“说穿了”“先说结论”。全部删除或改写。

检查模型常用的洞察路标。“更微妙的是”、“还有一层”、“只说对了一半”、“值得注意的是”、“需要指出的是”、“从某种意义上说”用来给段落抬高时删除。文字确实在说楼层、数量或原句本义时保留。

下面这些词在本 Skill 中作为绝对禁词处理。赋能、抓手、商业闭环、价值闭环、闭环、能力沉淀、打法、拉通、底层逻辑、顶层设计、认知跃迁、价值释放、能力建设、降本增效、内容矩阵、全链路、组合拳、打开想象空间、想象空间、结构性机会、关键命题、深层逻辑、技术底座、公共底座、技术主权、单点风险、主脊柱、材料锚点、认知增量、迭代闭环。改成人、动作、钱、时间与后果。

下面这些词只做语境检查。沉淀、颗粒度、对齐、协同、链路、生态位、心智、范式、方法论、核心变量。它们确实表示化学沉淀、排版对齐、生态学概念、学术概念或其他不可替代的本义时保留；只是在给普通事情抬价时改写。
